...
import { Play, BarChart3, Shield, Zap } from "lucide-react"
    ...
    <section className="relative min-h-screen flex items-center justify-center animated-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <Button
          ...
          className={`bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 scroll-reveal animate-pulse-glow ${isScanning ? "animate-rotate-scan" : ""}`}
        >
